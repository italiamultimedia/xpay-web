...
final class ItalianNexiErrorMessageProvider
{
    public function getCustomerMessage(?NexiErrorCode $errorCode): string
    {
        return match ($errorCode) {
            NexiErrorCode::DUPLICATE_ORDER => 'Questa richiesta di pagamento esiste già. '
            ...
            NexiErrorCode::PAYMENT_VALIDATION_INTERNAL_ERROR => 'Si è verificato un problema temporaneo durante '
                . 'l\'elaborazione del pagamento. Riprova.',
